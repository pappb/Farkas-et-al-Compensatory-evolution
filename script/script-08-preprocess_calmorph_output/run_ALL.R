...
source("script/script-16-helper-selftest/script-01-compare_calmorph_input_and_output_images.R") # selftest
...
source("script/script-08-preprocess_calmorph_output/script-12-03-delete_genotypes_not_enough_replicates_or_no_ancestor.R")
