...
# The only difference is that the first version takes care about the ancestor-evolved. 
# teh secound verion is used for datasets where there are no ancestor and evolved versions os strains.


# the output of CalMorph is some xls files for each  plate.
...
source("R-scripts/preprocess_calmorph_output/script-12-03-delete_genotypes_not_enough_replicates_or_no_ancestor.R")
...
source("R-scripts/preprocess_calmorph_output/script-102-generate_100_cell_images_per_genotipes_ordered_by_cellsize.R") # generates images about 100 individual cells per genotype
